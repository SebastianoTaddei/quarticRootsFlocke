...
Fork of [quarticRootsFlocke](https://github.com/ebertolazzi/quarticRootsFlocke) by Enrico Bertolazzi.
...
```bash
git clone --branch stable --depth 1 https://github.com/SebastianoTaddei/quarticRootsFlocke.git
cd quarticRootsFlocke
ruby setup.rb
rake
```
